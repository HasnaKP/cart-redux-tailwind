  ...
  return (
    ...
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
      ...
      <ul className='flex-1 text-right'>
        {
          insideHome &&
          <li className='list-none inline-block px-5'><input style={{width:'300px'}}  onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))} type="text" className='rounded p-2 text-black' placeholder='search product here...' /></li>
        }
